...
interface FamousBlockChainSectionCustomeWebAppProps {}
...
const FamousBlockChainSectionCustomeWebApp: FC<
  FamousBlockChainSectionCustomeWebAppProps
> = () => {
  return (
...
export default FamousBlockChainSectionCustomeWebApp;
