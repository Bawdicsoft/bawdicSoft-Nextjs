...
interface MasterMachineSectionCustomWebAppProps {}
...
const MasterMachineSectionCustomWebApp: FC<
  MasterMachineSectionCustomWebAppProps
> = () => {
...
export default MasterMachineSectionCustomWebApp;
