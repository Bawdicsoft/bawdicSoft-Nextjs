...
interface FamousBlockChainSectionWebDesignProps {}
...
const FamousBlockChainSectionWebDesign: FC<
  FamousBlockChainSectionWebDesignProps
> = () => {
  return (
...
export default FamousBlockChainSectionWebDesign;
