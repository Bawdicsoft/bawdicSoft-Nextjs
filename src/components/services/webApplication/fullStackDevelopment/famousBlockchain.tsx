...
interface FamousBlockChainSectionFullStackProps {}
...
const FamousBlockChainSectionFullStack: FC<
  FamousBlockChainSectionFullStackProps
> = () => {
  return (
...
export default FamousBlockChainSectionFullStack;
