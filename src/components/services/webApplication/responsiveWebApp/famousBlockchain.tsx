...
interface FamousBlockChainSectionResponsiveWebAppProps {}
...
const FamousBlockChainSectionResponsiveWebApp: FC<
  FamousBlockChainSectionResponsiveWebAppProps
> = () => {
  return (
...
export default FamousBlockChainSectionResponsiveWebApp;
