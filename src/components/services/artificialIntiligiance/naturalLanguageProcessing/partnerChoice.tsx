...
interface partnerChoiceSectionNaturalLanguageProps {}
...
const PartnerChoiceSectionNaturalLanguage: FC<
  partnerChoiceSectionNaturalLanguageProps
> = () => {
...
export default PartnerChoiceSectionNaturalLanguage;
