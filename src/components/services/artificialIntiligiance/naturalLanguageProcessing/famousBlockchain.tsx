...
interface FamousBlockChainSectionNaturalLanguageProps {}
...
const FamousBlockChainSectionNaturalLanguage: FC<
  FamousBlockChainSectionNaturalLanguageProps
> = () => {
  return (
...
export default FamousBlockChainSectionNaturalLanguage;
