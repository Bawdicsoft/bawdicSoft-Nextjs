...
interface partnerChoiceSectionMahcineLearningProps {}
...
const PartnerChoiceSectionMahcineLearning: FC<
  partnerChoiceSectionMahcineLearningProps
> = () => {
...
export default PartnerChoiceSectionMahcineLearning;
