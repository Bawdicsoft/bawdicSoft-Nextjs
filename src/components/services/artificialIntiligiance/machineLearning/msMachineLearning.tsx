    ...
    <div className=" flex justify-center items-center">
      <div className=" grid grid-cols-1 px-5 gap-5  md:grid-cols-2    py-16">
        <div className="max-w-lg lg:max-w-lg self-center  px-5   order-2 md:order-none">
          ...
          Master predictive analytics with Us. From refining reversion models to grasping ensemble learning, we transform raw data into actionable insights. Precise predictions boost-up confident decision-making.
