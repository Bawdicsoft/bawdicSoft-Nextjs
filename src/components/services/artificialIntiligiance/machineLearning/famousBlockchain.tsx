...
interface FamousBlockChainSectionMachineLearningProps {}
...
const FamousBlockChainSectionMachineLearning: FC<
  FamousBlockChainSectionMachineLearningProps
> = () => {
  return (
...
export default FamousBlockChainSectionMachineLearning;
