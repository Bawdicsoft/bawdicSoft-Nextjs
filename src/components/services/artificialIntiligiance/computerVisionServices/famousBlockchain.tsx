...
interface FamousBlockChainSectionComputerVisionProps {}
...
const FamousBlockChainSectionComputerVision: FC<
  FamousBlockChainSectionComputerVisionProps
> = () => {
  return (
...
export default FamousBlockChainSectionComputerVision;
