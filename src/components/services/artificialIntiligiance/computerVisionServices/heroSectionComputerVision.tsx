...
const HeroSectionComputerVision: FC<deFiSectionProps> = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url(/images/ServicesPagesCoverImages/Computer_vision.jpg)`,
    ...
    >
      <div className="px-4 mx-auto max-w-7xl text-center  md:pt-56 lg:py-56">
        ...
        Potentiate Tomorrow: See the Future through Our Lens – BawdicSoft’s Computer Vision Services.         </p>
      </div>
    </section>
  );
};
