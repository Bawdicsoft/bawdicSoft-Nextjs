...
interface FamousBlockChainSectionCustomeAiProps {}
...
const FamousBlockChainSectionCustomeAi: FC<
  FamousBlockChainSectionCustomeAiProps
> = () => {
  return (
...
export default FamousBlockChainSectionCustomeAi;
