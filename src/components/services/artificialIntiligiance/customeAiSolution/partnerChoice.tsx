...
interface partnerChoiceSectionCustomAiProps {}
...
const PartnerChoiceSectionCustomAi: FC<
  partnerChoiceSectionCustomAiProps
> = () => {
...
export default PartnerChoiceSectionCustomAi;
