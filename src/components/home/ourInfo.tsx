...
const OurInfoSection: FC<OurInfoSectionSectionProps> = () => {
    return (
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 px-5 lg:px-0 py-24">
            <Image src={"/images/AI/LLM.webp"} alt="" width={400} height={400} className="rounded-3xl w-full" />
            <div className="flex flex-col gap-2 self-center ">
                <h2 className="text-2xl md:text-3xl font-bold lg:text-4xl">Lorem ipsum dolor sit adipisicing elit. Pariatur</h2>
