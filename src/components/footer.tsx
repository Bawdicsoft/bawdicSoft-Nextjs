...
const Footer: FC<footerProps> = () => {
  ...
  return (
    ...
    // New Footer
    <div className="pt-8 pb-3 md:py-10 mt-52 bg-gradient-to-r from-sky-950 rounded-tr-[50px] rounded-tl-[50px] md:rounded-tr-[100px]  md:rounded-tl-[100px]   via-sky-700 via-30% to-sky-600 to-70%">
          ...
          <div className="flex flex-col gap-3">
            <a href="/" className="flex items-center justify-center">
              <Image
                ...
                alt="BowdicSoft Logo"
              />
              <span className="self-center text-xl md:text-3xl font-bold  text-white pl-2">
                BawdicSoft
              </span>
            </a>
            <p className="text-sm md:text-md font-semibold text-gray-200 text-center">
              Sofware Services and Development
            </p>
            <div className="flex justify-evenly  flex-wrap  md:gap-2 md:py-5">
              <Link
