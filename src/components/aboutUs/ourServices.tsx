...
const OurSevices: FC<ourSevicesProps> = () => {
  return (
    ...
    <div>
      <section
        className="relative rounded-br-[250px] rounded-b-[250px] rounded-bl-[250px] flex justify-center  md:mb-32 px-5 md:px-10  flex-col items-center mt-16 py-24 pb-32  bg-gradient-to-r from-sky-950   via-sky-700 via-30% to-sky-600 to-70%
     bg-blend-multiply "
      >
